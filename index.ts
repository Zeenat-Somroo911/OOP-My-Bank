...
interface BankAccount {
    ...
    balance: number;
    accountType: string; // Added account type
    ...
    closeAccount(): void;
    getAccountType(): string; // New method for account type
    setAccountType(type: string): void; // New method to set account type
    applyOverdraftProtection(): void; // New method for overdraft protection
}
...
class BankAccount implements BankAccount {
    ...
    constructor(accountNumber: number, balance: number, accountType: string = "Checking") {
...
async function performBankOperations(customer: Customer) {
...
async function handleDeposit(customer: Customer) {
...
async function handleWithdrawal(customer: Customer) {
